...
(function() {
  ...
  var hornSounds = {
      normal: '/sounds/airhorn.mp3',
      rap: '/sounds/rap-airhorn.mp3'
  };

  var selectedSound = 'normal';
  ...
  var Horn = function() {
    ...
    var loadSound = function(callback) {
      ...
      xhr.open('GET', hornSounds[selectedSound] );
    ...
    Array.prototype.forEach.call(
        document.getElementsByClassName('sound-select'),
        function(button) {
            button.onclick = function() {
                buffer = null;
                selectedSound = button.value;
                init();
            }
        }
    );
